...
public class Lab03 implements GLEventListener {
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        //8
        MidpointLine(gl, 10,10,10,60);
        MidpointLine(gl, 40,10,40,60);
        MidpointLine(gl, 10,10,40,10);
        MidpointLine(gl, 10,60,40,60);
        MidpointLine(gl, 10,35,40,35);
        //4
        MidpointLine(gl, 80,10,80,60);
        MidpointLine(gl, 50,35,80,60);
        MidpointLine(gl, 50,35,80,35);
